  ...
  def __init__(self):
    ...
    self.items_to_handlers = {
      ...
      fields.InputDataFields.groundtruth_text: \
        slim_example_decoder.Tensor(fields.TfExampleFields.transcript_gt),
      fields.InputDataFields.groundtruth_text_with_blank: \
        slim_example_decoder.Tensor(fields.TfExampleFields.transcript_gt_with_blank),
