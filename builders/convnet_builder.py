...
from Chinese_aster.protos import convnet_pb2
from Chinese_aster.convnets import crnn_net
from Chinese_aster.convnets import resnet
from Chinese_aster.convnets import stn_convnet
